...
const MathWorksheetSolver = () => {
  ...
  const renderWorksheet = () => {
    ...
    // Group problems into rows of 20
            ...
            <div key={rowIndex} className="mb-8">
              <div className="flex items-center gap-2 mb-3">
                ...
                <div className="text-sm text-gray-600">
                  Problems {rowIndex * problemsPerRow + 1} - {Math.min((rowIndex + 1) * problemsPerRow, problems?.length)}
                </div>
              </div>
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100 p-8">
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-8">
          ...
          <p className="text-gray-600">Upload your worksheet and get instant solutions</p>
        </div>
    ...
    <div className="bg-gradient-to-br from-white to-blue-50 rounded-lg shadow-md p-3 border-2 border-blue-200 hover:shadow-lg transition-all">
      ...
      <div className="space-y-1 mb-3">
        {problem?.numbers.map((num, idx) => (
          ...
          >
            <span className={`font-mono font-semibold text-sm ${num < 0 ? 'text-red-600' : 'text-gray-800'}`}>
              {num}
            </span>
          </div>
        ))}
